<%@ Page Language="C#" AutoEventWireup="true" CodeFile="show.aspx.cs" Inherits="huabao_show" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0">
			...
			<asp:PlaceHolder ID="PlaceHolder1" runat="server" Visible='<%# (Container.ItemIndex + 1) % 5 ==1 %>'>
                ...
                <td onmouseover="this.className='divRedLine'" onmouseout="this.className='divOutLine'" valign="top" class="divOutLine">
                    <ul>
                        <li style="text-align:center; width:184px; height:184px;" class="divLineDotted"><a href="/show/<%# Eval("num_iid").ToString().Trim() %>.htm" target="_blank"><img id="imgshow" src="<%# Eval("pic_url").ToString().Trim() %>_310x310.jpg" alt="<%# Eval("title").ToString().Trim() %>" title="<%# Eval("title").ToString().Trim() %>" style="width:184px; height:184px;" /></a></li>

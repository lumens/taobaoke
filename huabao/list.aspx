<%@ Page Language="C#" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="huabao_list" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" align="center">
			...
			<asp:PlaceHolder ID="PlaceHolder1" runat="server" Visible='<%# (Container.ItemIndex + 1) % 5 ==1 %>'>
                ...
                <td onmouseover="this.className='divRedLine'" onmouseout="this.className='divOutLine'" valign="top" class="divOutLine">
                    <ul>
                        <li style="text-align:center;"><a href="/huabao/show/<%# Eval("id").ToString().Trim() %>.htm" target="_blank"><img class="divLineDotted" src="<%# Eval("cover_pic_url_h").ToString().Trim() %>" style="height:230px; width:180px;" alt="<%# Eval("title_short").ToString().Trim() %>" title="<%# Eval("title").ToString().Trim() %>" id="imgshow" /></a></li>                        
                        <li style="height:26px; line-height:26px; text-align:center; color:#666666;"><a href="/huabao/show/<%# Eval("id").ToString().Trim() %>.htm" target="_blank" style="font-size:14px;"><%# Eval("title_short").ToString().Trim()%></a></li>
                    </ul>
                </td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="item_Default" %>
    ...
    <div class="divWidth">
        <div class="divHuiLine">
            ...
            <div style="padding:8px 0px 8px 8px;">
                <asp:Literal ID="ppClass" runat="server" ViewStateMode="Disabled"></asp:Literal>
            </div>
        </div>
    </div>
    <div class="divWidth">
